...
backfill_start = os.environ.get("BACKFILL_START", "2025-06-01")     # Can be YYYY-MM-DD or -60d format
backfill_end = os.environ.get("BACKFILL_END", "2025-07-01")         # Optional: YYYY-MM-DD format, empty means "now"
