...
backfill_start = os.environ.get("BACKFILL_START", "2025-10-01")     # Can be YYYY-MM-DD or -60d format
backfill_end = os.environ.get("BACKFILL_END", "2025-05-18")         # Optional: YYYY-MM-DD format, empty means "now"
